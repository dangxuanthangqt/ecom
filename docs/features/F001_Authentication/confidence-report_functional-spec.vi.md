---
source_artifact: docs/features/F001_Authentication/functional-spec.md
claims_total: 0
...
# Báo cáo độ tin cậy -- docs/features/F001_Authentication/functional-spec.md
...
|---|---|---|---|
| _(không phát hiện -- không tìm thấy trích dẫn `**Source:**` hoặc tag đánh dấu nào)_ | — | — | — |
...
- Không phát hiện khẳng định nào (không có trích dẫn hay tag đánh dấu) -- chỉ số độ phủ không có ý nghĩa với artifact này.
</content>
